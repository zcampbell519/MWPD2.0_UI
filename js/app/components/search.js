function SearchController($scope){  
    ...
    // TODO: Get from API: 
        ...
        $scope.Clear=function(){
            ...
            for(var group in $scope.SearchParams)
                for (var key in $scope.SearchParams[group]){
                    var item =$scope.SearchParams[group][key];
                    item.SearchIsVisible=false;
                    item.SelectedItems=[]
                }
